The aim of this project is to create a program that works like the printf function that is contained in the stdio.h c library. It contains the following tasks.
